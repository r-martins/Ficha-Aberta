 ...
 */
class CiLogs extends \Entity\CiLogs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'uri', 'method', 'params', 'apiKey', 'ipAddress', 'time', 'authorized');
    }
